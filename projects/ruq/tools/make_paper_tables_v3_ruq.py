...
MODEL_DISPLAY_NAMES = {
    ...
    "mask_rcnn_r50_quality_uncertainty_fpn": "Mask R-CNN + Quality + Uncertainty",
    "mask_rcnn_r50_fpn": "Mask R-CNN R50",
    "mask_rcnn_r101_fpn": "Mask R-CNN R101",
    "solo_r50": "SOLO R50",
    "yolact_r50": "YOLACT R50",
    "condinst_r50": "CondInst R50",
    "mask_rcnn_r50_cbam_fpn": "Mask R-CNN + CBAM",
    "mask_rcnn_r50_aspp_fpn": "Mask R-CNN + ASPP",
    "mask_rcnn_r50_boundary_fpn": "Mask R-CNN + Boundary",
    "mask_rcnn_r50_cbam_aspp_fpn": "Mask R-CNN + CBAM + ASPP",
    "mask_rcnn_r50_aspp_boundary_fpn": "Mask R-CNN + ASPP + Boundary",
    "mask_rcnn_r50_cora_noboundary_fpn": "CORA-Mask R-CNN w/o Boundary",
    "mask_rcnn_r50_cora_fpn": "CORA-Mask R-CNN",
}
...
MODEL_ORDER = [
    ...
    "PointRend R101",
    "Mask R-CNN + Quality",
    "Mask R-CNN + Uncertainty",
    "Mask R-CNN + Quality + Uncertainty",
    "RUQ-Mask R-CNN",
    "RUQ-Mask R-CNN R101",
    "SOLO R50",
    "YOLACT R50",
    ...
    "Mask R-CNN + ASPP",
    "Mask R-CNN + Boundary",
    "Mask R-CNN + CBAM + ASPP",
    "Mask R-CNN + ASPP + Boundary",
    "Mask R-CNN + Quality",
    "Mask R-CNN + Uncertainty",
    "Mask R-CNN + Quality + Uncertainty",
    "RUQ-Mask R-CNN",
    "CORA-Mask R-CNN w/o Boundary",
    "CORA-Mask R-CNN",
]
