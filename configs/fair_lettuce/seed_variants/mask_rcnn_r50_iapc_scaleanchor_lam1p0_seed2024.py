...
# he thong qua _base_ - file nay OVERRIDE rieng de dam bao seed=2024
...
randomness = dict(seed=2024, deterministic=True)
work_dir = 'work_dirs/research/mask_rcnn_r50_iapc_scaleanchor_lam1p0/seed_2024'
